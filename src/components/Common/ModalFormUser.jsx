...
import { updateDataUser } from "@/lib/actions/data-update-user";
...
export function ModalFormUser({ prompt }) {
    // console.log(prompt); // This is data from api
    ...
    const handleModal = async (e) => {
        ...
        // TODO: Update data of database
        const res = await updateDataUser(prompt?._id, updatedData);
