                                    ...
                                    <Table.Row key={prompt._id} className="bg-[#0b1410] hover:bg-black transition-colors group">
                                        ...
                                        <Table.Cell className="bg-transparent py-4 px-4 text-right border-none">
                                            <div className="flex items-center justify-end gap-3 ">
                                                <Link href={`/prompts/${prompt?._id}`} className="bg-blue-500/70 text-white hover:text-[#95d542] transition-colors p-2.5 rounded-lg border border-transparent hover:border-[#72b01d]/30" title="View Details">
                                                    <Eye width={18} />
                                                </Link>
